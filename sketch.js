...
function setup() {
  ...
  hexagon = new Hexagon(350,100,120);

  slingshot1 = new sling(hexagon.body,{x:350,y:110})
...
function keyPressed()
{
  if (keyCode === 32)
  {
    Matter.Body.setPosition(hexagon.body, {x:350, y:100}) 
...
function mouseDragged()
{
 ...
 // Matter.Body.applyForce(hexagon.body,hexagon.body.position,{x:mouseX+100,y:mouseY});
